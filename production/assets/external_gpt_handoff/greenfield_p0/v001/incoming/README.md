...
`_archive/legacy_full_manifest_drop_2026-05-22/` contains files from the older full-manifest intake shape:
...
Those files are kept as evidence/source history only. They are not part of the active three-image scene-layer contract.
