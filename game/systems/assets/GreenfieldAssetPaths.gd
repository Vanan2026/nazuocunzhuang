...
const HOME_AREA_MOTHER := "res://assets/scenes/home_area/scene_home_area_mother.png"
const HOME_AREA_BASE := "res://assets/scenes/home_area/scene_home_area_base.png"
const HOME_AREA_FOREGROUND_OCCLUSION := "res://assets/scenes/home_area/scene_home_area_foreground_occlusion.png"
const HOME_AREA_COLLISION_MASK := "res://assets/scenes/home_area/scene_home_area_collision_mask.png"
